...
**System:** Windows 11
**Python:** 3.12.10
**pytest flags (verbose pass):** `-v -s --tb=long --show-capture=all`
**Total Repos:** 13
...
**Note:** Core SSZ qubit implementation — primary reference
| Key | Value |
|-----|-------|
| exit_code | `0` |
| duration (verbose pass) | `6.88s` |
| passed | `184` |
| failed | `0` |
| total | `184` |
...
**Note:** Pure SSZ metric — canonical field equations
| Key | Value |
|-----|-------|
| exit_code | `0` |
| duration (verbose pass) | `20.86s` |
| passed | `36` |
| failed | `0` |
| total | `36` |
| failures_expected | `False` |
...
**Note:** Schumann resonance SSZ coupling
| Key | Value |
|-----|-------|
| exit_code | `0` |
| duration (verbose pass) | `17.71s` |
| passed | `201` |
| failed | `0` |
| total | `201` |
| failures_expected | `False` |
...
**Note:** G79.29+0.46 Cygnus observational tests
| Key | Value |
|-----|-------|
| exit_code | `0` |
| duration (verbose pass) | `16.23s` |
| passed | `3` |
| failed | `0` |
| total | `3` |
| failures_expected | `False` |
...
**Note:** Gravitational lensing (PPN null-geodesic)
| Key | Value |
|-----|-------|
| exit_code | `0` |
| duration (verbose pass) | `18.42s` |
| passed | `279` |
| failed | `0` |
| total | `279` |
| failures_expected | `False` |
...
**Note:** Geodesic trajectory integration
| Key | Value |
|-----|-------|
| exit_code | `0` |
| duration (verbose pass) | `6.49s` |
| passed | `63` |
| failed | `0` |
| total | `63` |
| failures_expected | `False` |
...
**Note:** Unified validation across all SSZ observables
| Key | Value |
|-----|-------|
| exit_code | `0` |
| duration (verbose pass) | `33.38s` |
| passed | `125` |
| failed | `0` |
| total | `125` |
| failures_expected | `False` |
...
```text
2026-04-29 10:04:16,034 [INFO] TEST_GAIA: Logger initialized -> data\logs\tests_2025-10-17_gaia_ssz_real_20260429_100416.log
2026-04-29 10:04:16,198 [INFO] TEST_GAIA: GAIA smoke rows=5000
2026-04-29 10:04:16,204 [INFO] TEST_SDSS: Logger initialized -> data\logs\tests_2025-10-17_gaia_ssz_real_20260429_100416.log
2026-04-29 10:04:16,213 [INFO] TEST_SDSS: SDSS smoke rows=5000
2026-04-29 10:04:16,216 [INFO] TEST_PLANCK: Logger initialized -> data\logs\tests_2025-10-17_gaia_ssz_real_20260429_100416.log
2026-04-29 10:04:16,217 [INFO] TEST_PLANCK: Planck CMB power spectrum present -> data\planck\COM_PowerSpect_CMB-TT-full_R3.01.txt
...
**Note:** Full calculation suite for SSZ observables
| Key | Value |
|-----|-------|
| exit_code | `0` |
| duration (verbose pass) | `10.62s` |
| passed | `158` |
| failed | `0` |
| total | `158` |
| failures_expected | `False` |
...
**Note:** Energy conditions and thermodynamics in SSZ
| Key | Value |
|-----|-------|
| exit_code | `0` |
| duration (verbose pass) | `10.73s` |
| passed | `2` |
| failed | `0` |
| total | `2` |
| failures_expected | `False` |
...
**Note:** Paper figure generation and data validation
| Key | Value |
|-----|-------|
| exit_code | `1` |
| duration (verbose pass) | `10.76s` |
| passed | `13` |
| failed | `3` |
| total | `16` |
| failures_expected | `False` |
...
**Note:** Star map visualizations — matplotlib-heavy, needs MPLBACKEND=Agg
| Key | Value |
|-----|-------|
| exit_code | `-1` |
| duration (verbose pass) | `900.11s` |
| passed | `0` |
| failed | `0` |
| total | `0` |
| failures_expected | `False` |
...
**Note:** Frequency-curvature coupling validation
| Key | Value |
|-----|-------|
| exit_code | `0` |
| duration (verbose pass) | `7.05s` |
| passed | `64` |
| failed | `0` |
| total | `64` |
| failures_expected | `False` |
...
```text
object address  : 000001BB7683AB00
object refcount : 5
object type     : 00007FFA066511F0
